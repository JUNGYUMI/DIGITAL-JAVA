...
public class VariableEx1 {
	static int num1; // 클래스멤버변수, 일반변수
	static A a1; // 클래스멤버변수, 참조변수
	int num2; // 객체멤버변수, 일반변수
	A a2; // 객체멤버변수, 참조변수
	public static void main(String[] args) {     		//String[] : 매개변수, 참조변수
		int num3; // 일반변수, 지역변수
		A a3; // 참조변수, 지역변수
		a3 = new A();
		a3.num = 10;			//num은 a3의 멤버변수
	}
	public static void test(int num1, A a1) {			//int num1 : 매개변수, 일반변수 
													 	//A a1 	: 매개변수, 참조변수
	}
}
class A{
 ...
 * 참조 변수 : 일반 변수가 아닌 변수로 클래스의 객체나 배열들이 있으며, 주소를 저장
 * 멤버 변수이면서 지역 변수가 될 수 있나? X
 */
