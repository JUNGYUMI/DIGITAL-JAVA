...
private int x1, y1;
	...
	/* getter와 setter
	 * getter는 멤버변수가 private인 경우 직접 멤버 변수의 값을 가져올 수 없기때문에 
	 멤버 변수의 값을 가져  올 수 있는 메서드이다
	 * setter는 멤버변수가 private인 경우 직접 멤버 변수의 값을 설정할 수 없기때문에
	...
	public static void printCount() {
		...
		//클래스 메서드는 객체 생성없이 사용이 가능하나 x1이라는 객체변수는 
		//객체를 생성해야 사용할 수 있는 변수이기때문에 클래스 메서드에서는 사용할 수 없다.
